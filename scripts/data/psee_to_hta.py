...
def build_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--k0", type=float, default=5.0e-6)
    ap.add_argument("--decay_b", type=float, default=2.0)
    ap.add_argument("--alpha", type=float, default=1.0)
    ap.add_argument("--kmin", type=float, default=1.0e-6)
    ap.add_argument("--kmax", type=float, default=1.2e-5)
    ...
    ap.add_argument("--recent_gamma", type=float, default=2.2)
    ap.add_argument("--recent_floor", type=float, default=0.08)
