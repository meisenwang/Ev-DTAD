...
DATA_PATH = './data/gen1_pseudorgb_coco'
TRAIN_ANN = 'labels/train.json'
TEST_ANN  = 'labels/test.json'
P_GEOM    = 0.6
P_ERASE   = 0.4
N_QUERY   = 300
N_DENOISE = 100

TRANSFER_PATH = './ckpt/gen1/frame/baseline_frame_rtdetr_coco_presnet50/model_m(frame-detection-rtdetr)_default'
...
# Config
    ...
    'epochs' : 200,
    'model'  : {
        'name'          : 'vcf-detection-dtad',
        'batch_first'   : BATCH_FIRST,
        'ema_momentum'  : 0,
        'frame_shape'   : (3, *FRAME_SIZE),
        'use_denoising' : True,
        'grad_clip' : {
            'value' : 5.0,
        },
...
# Args
    'checkpoint' : 10,
    'label'      : 'default',
    'outdir'     : './ckpt/gen1/video/video_rtdetr_coco_presnet50',
}
