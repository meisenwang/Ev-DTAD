...
DATA_PATH = './data/etram_pseudorgb_coco'
...
TRANSFER_PATH = './ckpt/etram/frame/etram_rtdetr_coco_presnet18/model_m(frame-detection-rtdetr)_default'
...
# Args
    'checkpoint' : 10,
    'label'      : 'default',
    'outdir'     : './ckpt/etram/video/video_rtdetr_coco_presnet18',
}
