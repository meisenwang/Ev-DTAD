...
DATA_PATH = './data/gen4_pseudorgb_coco'
...
TRANSFER_PATH = './ckpt/gen4/frame/frame_rtdetr_coco_presnet18/model_m(frame-detection-rtdetr)_default'
...
# Args
    'checkpoint' : 10,
    'label'      : 'default',
    'outdir'     : './ckpt/gen4/video/video_rtdetr_coco_presnet50',
}
